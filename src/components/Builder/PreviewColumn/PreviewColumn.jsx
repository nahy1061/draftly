...
function PreviewColumn() {
  ...
  return (
    <div
      className={`${activeTab === "preview" ? "block" : "hidden"} md:block print:block flex-1 p-6 md:border-l border-slate-200/50 dark:border-slate-800/50 bg-slate-50/50 dark:bg-[#080B13]/40 transition-colors duration-300`}
    >
